...
Thank you for your interest in contributing to this project. To protect both
contributors and the project owner, and to allow the project to be licensed
commercially in the future, all contributors must agree to this CLA before
their contributions can be accepted.
...
You grant the project owner (Patrick Bihn) a perpetual, worldwide, non-exclusive,
no-charge, royalty-free, irrevocable copyright license to reproduce, prepare
derivative works of, publicly display, publicly perform, sublicense, and
distribute your contributions and such derivative works, under any license
the project owner chooses, including proprietary and commercial licenses.
...
project owner. You retain full copyright ownership. The license granted above
is in addition to any rights you retain, not a replacement.
...
By opening a pull request and including the following statement in your PR
description, you confirm your agreement to this CLA:
